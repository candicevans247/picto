    ...
    <div className="py-25 max-w-169 mx-auto px-2">
      <div className="text-center">
        ...
        <p className="text-[#A5ACB5] text-xs sm:text-lg font-normal text-center pb-8">
          I create brand-aligned visuals that enhance engagement, build trust, and strengthen your digital presence. Let's discuss your project and bring your brand vision to life.
        </p>
        <a
